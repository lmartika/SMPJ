...
config.JobType.psetName = 'ProcessedTreeProducer16Hp.py'
...
# Herwig++ Flat
config.General.requestName = 'QCD16_CUETHS1_Flat_TrancheIV_v6-1'
config.Data.inputDataset = '/QCD_Pt-15to7000_TuneCUETHS1_Flat_13TeV_herwigpp/RunIISummer16DR80Premix-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/AODSIM'
